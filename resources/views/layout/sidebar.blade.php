        ...
        <div
            ...
            <div class="flex pt-4">
                <a href="{{route('dashboard')}}l">
                    <img style="width: 70px"
                         ...
                         src="{{asset('user/images/app-logo.png')}}" alt="logo" />
                </a>
            </div>
            ...
            <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
                ...
                <a href="{{route('investment')}}"
                   ...
                   x-tooltip.placement.right="'Invest'">
                ...
                <a href="{{route('detail')}}"
                   class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                   x-tooltip.placement.right="'Personal Details'">
                    <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a href="{{route('team')}}"
                   class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                   x-tooltip.placement.right="'My Team'">
                    <svg class="h-7 w-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-opacity="0.25"
                              d="M21.0001 16.05V18.75C21.0001 20.1 20.1001 21 18.7501 21H6.6001C6.9691 21 7.3471 20.946 7.6981 20.829C7.7971 20.793 7.89609 20.757 7.99509 20.712C8.31009 20.586 8.61611 20.406 8.88611 20.172C8.96711 20.109 9.05711 20.028 9.13811 19.947L9.17409 19.911L15.2941 13.8H18.7501C20.1001 13.8 21.0001 14.7 21.0001 16.0"
                              fill="currentColor" />
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
                ...
                <div x-data="usePopper({placement:'right-end',offset:12})"
                    ...
                    <button @click="isShowPopper = !isShowPopper" x-ref="popperRef" class="avatar h-12 w-12">
                        <img class="rounded-full" src="{{asset('user/images/avatar/avatar-12.jpg')}}" alt="avatar" />
                        <span
...
<nav class="header before:bg-white dark:before:bg-navy-750 print:hidden">
    ...
    <div class="header-container relative flex w-full bg-white dark:bg-navy-750 print:hidden">
        ...
        <div class="flex w-full items-center justify-between">
            ...
            <div class="h-7 w-7">
                <button
                    class="menu-toggle hidden ml-0.5 flex h-7 w-7 flex-col justify-center space-y-1.5 text-primary outline-none focus:outline-none dark:text-accent-light/80"
                            ...
                            <div
                                ...
                                <div class="is-scrollbar-hidden overflow-y-auto overscroll-contain pb-2">
                                    <div class="is-scrollbar-hidden mt-3 flex space-x-4 overflow-x-auto px-3">
                                        ...
                                        <a href="index.html" class="w-14 text-center">
                                            <div class="avatar h-12 w-12">
